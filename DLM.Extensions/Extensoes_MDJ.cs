            ...
            foreach (var grp in bnz.Furos)
            {
                ...
                switch (grp.Tipo)
                {
                    ...
                    case MB_Tipo_Puncao.No_Padrao:
                        corfr = netDxf.AciColor.Green;
                        break;
                    case MB_Tipo_Puncao.Emenda_Inicial:
                        corfr = netDxf.AciColor.Magenta;
                        break;
                    case MB_Tipo_Puncao.Emenda_Final:
                        corfr = netDxf.AciColor.Magenta;
                        break;
                    case MB_Tipo_Puncao.Extremidade_Inicial:
                        corfr = netDxf.AciColor.Yellow;
                        break;
                    case MB_Tipo_Puncao.Extremidade_Final:
                        corfr = netDxf.AciColor.Yellow;
                        break;
                }
