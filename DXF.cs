    ...
    public static class Dxf
    {
        ...
        public static List<P3d> GetOrigens(List<EntityObject> Objetos, bool cotas = false)
        {
            ...
            foreach (var ob in Objetos)
            {
                ...
                else if (ob is Polyline)
                {
                    var t = ob as Polyline;
        ...
        public static DimensionStyle GetEstilo(string Nome, double escala)
        {
            ...
            retorno.TextStyle = new TextStyle("romans__.ttf");
        ...
        {
            var leader = new Leader(Texto, Vetores.Select(x => x.Vector2()));
        ...
        {
            var texto = new Text(valor, Origem.Vector2(), tamanho);
        ...
        public static Polyline Retangulo(double Comprimento, double Largura, double X = 0, double Y = 0, Layer Layer = null, AciColor Cor = null)
        {
        ...
        public static Polyline Polilinha(List<P3d> Origens, Layer Layer = null, AciColor Cor = null, Linetype tipo = null)
        {
            var Vetores = new List<Vector3>();
